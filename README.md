...
- `assets/business-logos/` — Employer logos displayed on transparent containers to the right of each business name in the webpage experience section.
...
- `assets/service-logos/` — U.S. Army employer mark displayed without a surrounding background or border to the right of the Army business name.
