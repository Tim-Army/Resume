...
readonly SCRIPT_NAME="create-one-page-resume-and-push-v4.sh"
...
PUSH_CHANGES=true
OPEN_PDF=false
COMMIT_MESSAGE="docs: add Webster University location to one-page resume"
SOURCE_SCRIPT=""
TEMP_SELF=""
VENV_DIR=""
...
Usage:
  create-one-page-resume-and-push-v4.sh [options]
...
Files created or updated:
  resume/master/Tim-Fox-Resume-one-page.md
  pdf/Tim-Fox-Concise-Resume.pdf
  scripts/bash/create-one-page-resume-and-push-v4.sh
