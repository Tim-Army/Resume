...
readonly SCRIPT_NAME="create-one-page-resume-and-push-v2.sh"
...
Usage:
  create-one-page-resume-and-push-v2.sh [options]
...
Files created or updated:
  resume/master/Tim-Fox-Resume-one-page.md
  pdf/Tim-Fox-Concise-Resume.pdf
  scripts/bash/create-one-page-resume-and-push-v2.sh
